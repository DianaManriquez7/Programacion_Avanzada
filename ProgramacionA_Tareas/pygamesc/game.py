...
velocidad_bala2 = -20  # Velocidad de la bala hacia la izquierda
...
def disparar_bala2():
    ...
    if not bala2_disparada:
        velocidad_bala2 = random.randint(-8, -3)  # Velocidad aleatoria negativa para la bala
        bala2_disparada = True

# Función para reiniciar la posición de la bala
def reset_bala2():
    global bala2, bala2_disparada
    bala2.x = w - 750  # Reiniciar la posición de la bala
    bala2_disparada = False
