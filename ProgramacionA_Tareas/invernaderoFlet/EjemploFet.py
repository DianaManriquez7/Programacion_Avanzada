    ...
    def mostrar_posiciones():
        ...
        if posiciones:
            for i, pos in enumerate(posiciones):
                lista_posiciones.controls.append(ft.Text(
                    f"Posición {i}: Hombro={pos['hombro']}, Codo={pos['codo']}, Muñeca={pos['muneca']}, Pinza={pos['pinza']}"))
        else:
    ...
    def cambiar_vista(menu_item):
        ...
        if menu_item == "Alta":
            container_opciones.controls.extend(
                [hombro, codo, muneca, pinza, ft.ElevatedButton("Guardar Posición", on_click=alta_click)])
        elif menu_item == "Baja":
            container_opciones.controls.extend(
                [indice_baja, ft.ElevatedButton("Eliminar Posición", on_click=baja_click)])
        elif menu_item == "Modificación":
            container_opciones.controls.extend([indice_modificar, hombro, codo, muneca, pinza,
                                                ft.ElevatedButton("Modificar Posición", on_click=modificar_click)])
